    ...
    if (data['code'] == "200") {
        ...
        if (data['type'] == "post") {
            ...
            <button onclick="" class="unlikeButton" title="不喜欢">
                ...
                <button onclick="" title="回复">
                    <span class="commentNum">回复</span>
                </button>
            </button>
        </div>`;
        }
...
<div class="inputBox">
    <div class="inputSurface"><div onclick="newMsgBox('开发中')" class="fakeInput" tabindex="0" onkeydown="divClick(this, event)" title="点击来发表评论">精彩的评论也是乐子的一部分</div>  
...
<div class="header">
    ...
    <div class="buttons">
        <button onclick="postContextMenu('{{type}}', '{{id}}', this);"><i class="material-icons">more_vert</i></button>
    </div>
</div>
<div class="content">
